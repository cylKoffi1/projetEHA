                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Réalisation des nouveaux projets</li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Réalisation: Nouveau projet</h4>
                   <!-- @if (count($errors) > 0)
                ...
                <div id="liste-projets" style="display: none;">
                    ...
                    <h4>Liste des nouveaux projets (Statut prévu)</h4>
                        ...
                        @php
                            ...
                            // Trouver le statut avec le code '01' pour ce projet
                            $statut = $statutsProjet->firstWhere('codeSStatu', '01');
                        @endphp
