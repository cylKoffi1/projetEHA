...
<section id="multiple-column-form">
            ...
            <div class="card">
                <div class="card-header">
                    <div  style="display: flex; width: 100%; justify-content: space-between; align-items: center;">
                        <h5 class="card-title">
                            Ajout d'un domaine
                            <a href="#" data-toggle="modal" data-target="#domaine-modal" style="margin-left: 15px;"><i class="bi bi-plus-circle me-1"></i></a>
                        </h5>
    ...
    <div class="modal fade" id="domaine-modal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Enregistrement de domaine</h5>
                        ...
                        <div class="row match-height">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form" method="POST" action="{{ route('domaine.store') }}" data-parsley-validate>
                                                @csrf
    ...
    <!-- Modal Modification -->
    <div class="modal fade" id="domaine-modal-edit" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Modification de domaine</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row match-height">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form" method="POST" action="{{ route('domaine.update') }}" data-parsley-validate>
                                                @csrf
                        <input type="hidden" class="form-control" id="ecran_id" value="{{ $ecran->id }}"  name="ecran_id" required>
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
...
<script>
    $(document).ready(function() {
        initDataTable('{{ auth()->user()->personnel->nom }} {{ auth()->user()->personnel->prenom }}', 'table1', 'Liste des domaines')
        ...
        $('#code').on('input', function() {
            ...
            $.ajax({
                url: '/check-domaine-code', // Replace with the actual URL in your Laravel routes
                method: 'POST'
                , data: {
    ...
    function showEditDomaine(code) {
        $('#domaine-modal-edit').modal('show');
        $.ajax({
            type: 'GET'
            , url: '/admin/domaine/' + code
