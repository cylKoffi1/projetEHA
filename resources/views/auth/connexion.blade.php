                        ...
                        <div class="col-12 col-md-6 text-bg-primary">
                            <div class="d-flex align-items-center justify-content-center h-100" style="margin-top: 50px;">
                                <div class="text-center">
                                    <img class="img-fluid rounded mb-4" loading="lazy" src="{{ asset('logoseul.png') }}" width="400" height="200" alt="Logo GP-INFRAS">
                                    <h2 class="h1 mb-4 text-white" style="color:rgb(52, 96, 227);">GP-INFRAS</h2>
                                </div>
                            </div>
                        </div>
