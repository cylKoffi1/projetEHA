                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Statut projet</li>
            ...
            <div class="card">
              ...
              <a  href="#" data-toggle="modal" data-target="#sous-prefecture-modal" style="margin-left: 15px;"><i class="bi bi-plus-circle me-1"></i></a>
                    ...
                    <div style="text-align: center;">
                        <h5 class="card-title"> Liste des statuts de projets</h5>
                    </div>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" style="width: 100%" id="table1">
                            ...
                            <tbody>
                                @foreach ($statutProjet as $statutProjet)
                                <tr>
                                    <td>{{ $statutProjet->code }}</td>
                                    <td>{{ $statutProjet->libelle }}</td>
                                    <td>
                                        <div class="dropdown">
...
<script>
    ...
    $(document).ready(function() {
        initDataTable('{{ auth()->user()->personnel->nom }} {{ auth()->user()->personnel->prenom }}', 'table1', 'Liste des status de projet')
    });
