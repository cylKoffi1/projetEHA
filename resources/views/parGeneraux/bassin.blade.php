...
<section id="multiple-column-form">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Bassin</li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div style="text-align: center;">
                       <h5 class="card-title"> Liste des bassins</h5>
                    </div>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" style="width: 100%" id="table1">
                            ...
                            <tbody>
                                @foreach ($bassin as $bassin)
                                <tr>
                                    <td>{{ $bassin->code }}</td>
                                    <td>{{ $bassin->libelle }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu z-3" aria-labelledby="userDropdown">
                                                <li><a class="dropdown-item" href="#"  onclick="showEditBassin('{{ $bassin->code }}')"><i class="bi bi-pencil-square me-3"></i> Modifier</a></li>
                                                <li><a class="dropdown-item" href="#"  onclick="deleteBassin('{{ $bassin->code }}')"> <i class="bi bi-trash3-fill me-3"></i> Supprimer</a></li>
    ...
    <div class="modal fade" id="bassin-modal" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Enregistrement de bassin</h5>
                    ...
                    <section id="multiple-column-form">
                        <div class="row match-height">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form" method="POST" action="{{ route('bassin.store') }}" data-parsley-validate>
                                                @csrf
                        <input type="hidden" class="form-control" id="ecran_id" value="{{ $ecran->id }}"  name="ecran_id" required>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <input type="submit" class="btn btn-primary" value="Enregistrer" id="enregistrerBassin">
                                                </div>
                                            </form>
    ...
    <div class="modal fade" id="bassin-modal-edit" tabindex="-1" role="dialog" aria-labelledby="modalTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Modification de bassin</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="row match-height">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form" method="POST" action="{{ route('bassin.update') }}" data-parsley-validate>
                                                @csrf
                        <input type="hidden" class="form-control" id="ecran_id" value="{{ $ecran->id }}"  name="ecran_id" required>
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
...
<script>
    $(document).ready(function() {
        initDataTable('{{ auth()->user()->personnel->nom }} {{ auth()->user()->personnel->prenom }}', 'table1', 'Liste des bassins')
        ...
        $('#code').on('input', function() {
            ...
            $.ajax({
                url: '/check-bassin-code', // Replace with the actual URL in your Laravel routes
                method: 'POST'
                , data: {
    ...
    function showEditBassin(code) {
        $('#bassin-modal-edit').modal('show');
        $.ajax({
            type: 'GET'
            , url: '/admin/bassin/' + code
