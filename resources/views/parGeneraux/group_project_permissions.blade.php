                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Groupe projet permission</li>
...
<section class="section">
    <div class="card">
        ...
        <div class="card-header">
            <h5>Gestion des permission pour Groupes Projets</h5>
        </div>
        <div class="card-body">
            <form id="group-project-permissions-form" action="{{ route('group_project_permissions.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <!-- Nombre Maximum de Groupes Projets -->
                    <div class="form-group col">
                        <label for="max_projects">Nombre Maximum de Groupes Projets</label>
                        <input type="number" class="form-control" id="max_projects" name="max_projects" min="0" required>
                    </div>
    ...
    <div class="card mt-3">
        <div class="card-header">
            <h5>Liste des Permissions pour Groupes Projets</h5>
        </div>
        <div class="card-body">
            <table class="table table-striped table-bordered" id="permissions-table">
                <thead>
                    <tr>
                        <th>Rôle Source</th>
                        <th>Nombre Maximum de Groupes Projets</th>
                        <th>Permission</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#" class="edit-button"
                                    ...
                                    data-max-projects="{{ $permission->max_projects }}"
                                ...
                                <form id="delete-form-{{ $permission->id }}" action="{{ route('group_project_permissions.destroy', $permission->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.edit-button').forEach(button => {
            button.addEventListener('click', function () {
                ...
                document.getElementById('max_projects').value = maxProjects;
                document.getElementById('can_assign').value = canAssign;

                const form = document.getElementById('group-project-permissions-form');
                form.action = `/group_project_permissions/${id}`;
