                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">type établissement</li>
            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; width: 100%; justify-content: space-between; align-items: center;">
                        <h5 class="card-title">
                            Ajout d'un type d'établissements
              ...
              <a  href="#" data-toggle="modal" data-target="#sous-prefecture-modal" style="margin-left: 15px;"><i class="bi bi-plus-circle me-1"></i></a>
                    ...
                    <div style="text-align: center;">
                        <h5 class="card-title"> Liste des types d'établissements</h5>
                    </div>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered" cellspacing="0" style="width: 100%" id="table1">
                            ...
                            <tbody>
                                @foreach ($typeEtablissement as $typeEtablissement)
                                <tr>
                                    <td>{{ $typeEtablissement->code }}</td>
