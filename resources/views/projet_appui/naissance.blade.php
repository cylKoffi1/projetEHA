        ...
        <div class="col-12">
          <div class="container mt-5">
            ...
            <form class="col-12" id="projectForm">
              {{-- ----- ORDRE DES STEPS ----- --}}
              @include('projet_appui.steps.Information_Generales')  {{-- step-1 (active) --}}
              @include('projet_appui.steps.projetselect')   
              @include('projet_appui.steps.beneficiaire')           {{-- step-2 --}}
              @include('projet_appui.steps.maitreOuvrages')         {{-- step-3 (ton MOA/MOE si renommé) --}}
              @include('projet_appui.steps.maitreOuvre')            {{-- step-4 (si besoin) --}}
              @include('projet_appui.steps.Financement')            {{-- step-5 --}}
              @include('projet_appui.steps.document')               {{-- step-6 --}}
            </form>
            @else
