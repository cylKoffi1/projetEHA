            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row g-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row g-2 align-items-center">
                                        <div class="col-auto"><label class="mb-0">Dates :</label></div>
                                        <div class="col-auto">
                                            <label class="mb-0"><input type="radio" id="radioButton1" name="radioButtons" value="prévisionnelles"> prévisionnelles</label>
                                        </div>
                                        <div class="col-auto">
                                            <label class="mb-0"><input type="radio" id="radioButton2" name="radioButtons" value="effectives"> effectives</label>
                                        </div>
                                        <div class="col-auto">
                                            <label class="mb-0"><input type="radio" id="radioButton3" name="radioButtons" value="Tous"> Sans filtre</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Bailleurs / Statut projet -->
                        <div class="col-md-4" id="status-bailleur">
                            <div class="row g-2">
                                <div class="col">
                                    <center><small>Bailleur</small></center>
                                ...
                                <div class="col">
                                    <center><small>Statut</small></center>
                        ...
                        <!-- Filtrage & état des infrastructures -->
                        <div class="col-md-2">
                            <div class="d-grid gap-2">
                                <button class="btn btn-secondary" id="filterButton" type="button">Filtrer</button>
                                <div>
                                    <small>État des infrastructures</small>
                                    <select id="infra_status" class="form-control">
                                        <option value="all" selected>Toutes</option>
                                        <option value="done">Terminées</option>
                                        <option value="ongoing">Non terminées</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<script>
    // par défaut, filtre cumul & métrique = infrastructures (géré dans map.js)
    window.currentMapFilter = 'cumul';
    ...
    window.openProjectDrawer = async function(params){
        ...
        let filters = 'privé';
        if (filter === 'public') filters = 'public';
        if (filter === 'cumul')  filters = 'cumul';
    ...
    // Mise à jour de la carte après filtre serveur (même structure que /api/projects)
    function updateMap(data){
        const filteredProjects = data.projets;
        if (!filteredProjects || filteredProjects.length === 0) {
            alert("Aucun enregistrement trouvé pour ce filtre.");
            return;
        }
        ...
        console.log('✅ Carte mise à jour (agrégat transmis).');
    }
...
{{-- map.js (nouvelle version) doit être placé dans public/geojsonCode/map.js --}}
